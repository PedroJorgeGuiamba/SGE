        ...
        <div class="formulario">
            <form action="../../Controller/Estagio/FormularioDeVisita.php" method="post" id="formularioEstagio">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        <label for="contactoFormando" class="form-label">Contacto Formando</label>
                        <input type="tel" name="contactoFormando" class="form-control" id="contactoFormando"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        <label for="nome_supervisor" class="form-label">Nome do Supervisor na Empresa</label>
                        <input type="text" name="nome_supervisor" class="form-control" id="nome_supervisor">
                        <span class="error_form" id="nome_supervisor_error_message"></span>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="contacto_supervisor" class="form-label">Contacto do Supervisor</label>
                        <input type="text" name="contacto_supervisor" class="form-control" id="contacto_supervisor">
                        <span class="error_form" id="contacto_supervisor_error_message"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="datahora" class="form-label">Data e Hora da Visita</label>
                        <input type="datetime-local" name="datahora" class="form-control" id="datahora" min="<?php echo date('Y-m-d\TH:i'); ?>">

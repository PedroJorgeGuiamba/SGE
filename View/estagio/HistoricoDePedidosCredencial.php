<?php require_once __DIR__ . '/../../Includes/header-estagio-admin.php' ?>
    ...
    <main class="container mt-4">
        ...
        <h2 class="mb-4">Histórico de Todos os Pedidos de Credencial</h2>
        ...
        <div class="mt-3">
            <a href="formularioDeCredencialDeEstagio.php" class="btn btn-primary">Novo Pedido</a>
            <a href="listaDePedidosCredencial.php" class="btn btn-success">Lista de Pedidos</a>

...
<head>
    ...
    <title>Formulário de Credencial de Estágio</title>
...
<body>
    ...
    <main>
        <div class="formulario">
            <form action="../../Controller/Estagio/FormularioDeCredencialDeEstagio.php" method="post" id="formularioEstagio">
    ...
    <script>
        $(document).ready(function() {
            $('#formCartaDeEstagio').submit(function(e) {
                ...
                $.ajax({
                    url: '../../Controller/Estagio/FormularioDeCredencialDeEstagio.php',
                    method: 'POST',
                    data: $(this).serialize(),
                    dataType: 'json',

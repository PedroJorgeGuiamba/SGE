        ...
        <section id="heroCarousel" class="carousel slide carousel-fade hero-carousel" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active" data-bs-interval="5000">
                    <img src="https://www.itc.ac.mz/wp-content/uploads/2020/07/itc-p.png" class="d-block w-100" alt="Fachada do Instituto">
                ...
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="https://www.itc.ac.mz/wp-content/uploads/2024/10/WhatsApp-Image-2024-10-29-at-14.36.59-7-768x1024.jpeg" class="d-block w-100" alt="Feira do ITC">
                    <div class="carousel-mask"></div>
                    <div class="carousel-caption">
                ...
                <!-- Slide 3 -->
                <div class="carousel-item" data-bs-interval="5000">
                    <img src="https://www.itc.ac.mz/wp-content/uploads/2023/10/WhatsApp-Image-2023-10-26-at-15.03.08-2.jpeg" class="d-block w-100" alt="Eventos e Formação">
                    <div class="carousel-mask"></div>
                    <div class="carousel-caption">
            ...
            <div class="container">
                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-6 about-text">
                        ...
                        <p class="lead">O Instituto de Transportes e Comunicações (ITC) é uma instituição de ensino técnico e profissional de referência nacional, focada em entregar educação de excelência e prática.</p>
                        <p>Nossa missão é qualificar jovens e adultos para o mercado de trabalho dinâmico, fornecendo competências sólidas nas áreas das tecnologias de informação, gestão empresarial, e claro, no nosso forte que engloba as comunicações e vias de transporte.</p>
                        <ul class="list-unstyled mt-4">
                            <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i> Corpo docente altamente qualificado</li>
                            <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i> Instalações e laboratórios modernos</li>
                            <li class="mb-3"><i class="fas fa-check-circle text-primary me-2"></i> Alta taxa de empregabilidade dos formandos</li>
                        </ul>
                    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6">
                                <div class="icon-box">
                                    ...
                                    <h4>Mercado</h4>
                                    <p class="text-muted small">Programas modulares alinhados ao mercado corporativo.</p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="icon-box">
                                    ...
                                    <h4>Certificação</h4>
                                    <p class="text-muted small">Diplomas reconhecidos a nível nacional e internacional.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div class="col fade-in">
                        <div class="card h-100">
                            <img src="https://www.itc.ac.mz/wp-content/uploads/2020/07/itc-p.png" class="card-img-top" alt="Fachada">
                            <div class="card-body">
                                <span class="badge bg-primary mb-2">Institucional</span>
                                <h5 class="card-title">Abertura do Novo Ano Lectivo</h5>
                                <p class="card-text">O Instituto de Transportes e Comunicações (ITC) prepara o arranque de mais um ano lectivo repleto de novos desafios e infraestruturas renovadas para os formandos.</p>
                            </div>
                    ...
                    <div class="col fade-in text-center" style="animation-delay: 0.1s;">
                        <div class="card h-100">
                            <img src="https://www.itc.ac.mz/wp-content/uploads/2024/10/WhatsApp-Image-2024-10-29-at-14.36.59-7-768x1024.jpeg" class="card-img-top" alt="Feira">
                            <div class="card-body text-start">
                                <span class="badge bg-success mb-2">Eventos</span>
                                <h5 class="card-title">Grande Feira de Ciências e Tecnologia</h5>
                                <p class="card-text">Participe na maior expô anual onde formandos expõem projectos tecnológicos, soluções de electrónica e propostas na área das comunicações criadas pelos mesmos.</p>
                            </div>
                            <div class="card-footer bg-transparent border-0 pb-3">
                    ...
                    <div class="col fade-in" style="animation-delay: 0.2s;">
                        <div class="card h-100">
                            <img src="https://www.itc.ac.mz/wp-content/uploads/2023/10/WhatsApp-Image-2023-10-26-at-15.03.08-2.jpeg" class="card-img-top" alt="Cerimônia">
                            <div class="card-body">
                                <span class="badge bg-warning text-dark mb-2">Graduação</span>
                                <h5 class="card-title">Cerimónia de Graduação e Corte do Bolo</h5>
                                <p class="card-text">Celebramos hoje a transição e a inserção no mercado de trabalho de mais uma centena de finalistas dos diversos cursos modulares realizados no ITC.</p>
                            </div>
                            <div class="card-footer bg-transparent border-0 pb-3">

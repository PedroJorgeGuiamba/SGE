        ...
        <div class="col-lg-10">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-white border-bottom-0 mt-3 pt-4 pb-0 text-center">
                    <h3 class="fw-bold text-primary"><i class="fas fa-graduation-cap me-2"></i>Associar Formador a Módulo</h3>
                    <p class="text-muted small">Preencha os campos abaixo para associar o formador e módulo no sistema</p>
                </div>
                <div class="card-body p-5">
                    <form action="/estagio/formador/salvar-associar-modulo" method="post">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-12 text-end">
                                <button type="submit" class="btn btn-primary shadow-sm px-5 py-2 fw-bold text-white"><i class="fas fa-save me-1"></i> Associar Formador ao Módulo</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script src="/estagio/Assets/JS/CadastrarFormadorModulo.js"></script>
</body>
